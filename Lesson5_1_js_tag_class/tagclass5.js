...
function Degistir() {
    ...
    //bütün aynı class'a sahip elementleri seçmek için for döngüsü kullanılabilir
    var elementList = document.getElementsByClassName("alan1");  

    //for (var i = 0; i < elementList.length; i++) {
    //    elementList[i].classList.add("alan3");
    //}
    //for ile yapılan işlemi Array.from() ile de yapabiliriz. Array.from() ile HTMLCollection'ı array'e çevirip forEach() ile her bir elemente istediğimiz class'ı ekleyebiliriz,yeni class'lar ekleyebiliriz, istenilen css özeelikleri toplu bir şekilde verebiliriz.
...
function TagNameFunction() {
    ...
    //var tagElement = document.getElementsByTagName("input")[1];
